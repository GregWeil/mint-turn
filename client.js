...
const dilate = Two.SVGRenderer.Utils.createElement('feMorphology', { operator: 'dilate', radius: 1, out: 'dilate' });
const blend = Two.SVGRenderer.Utils.createElement('feBlend', { in: 'SourceGraphic', in2: 'dilate' });
